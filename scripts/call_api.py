...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", type=str, default="http://127.0.0.1:8000/predict", help="URL of the prediction endpoint.")
    ...
    if args.input:
        ...
        if "predict_batch" not in args.url:
            print("Warning: URL does not seem to point to a _batch endpoint. Adjusting...")
