...
from mlops.data_load.data_load import (
    load_config, date_to_ms, default_window, load_symbols,
    fetch_binance_klines, fetch_binance_funding_rate, fetch_data
)
...
def test_fetch_data_against_sample():
    ...
    actual_df = actual_df[actual_df["timestamp"].isin(timestamps)].reset_index(drop=True)
