...
class TestEvaluationRun:
    ...
    def test_evaluation_run_script_exists(self):
        """Test that the evaluation run.py script exists"""
        script_path = self.find_evaluation_run_script()
        assert script_path is not None, "Could not find evaluation run.py script"
